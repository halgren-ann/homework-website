...
<body>
    <div class="centered">
        ...
        <form action="addTaskToDB.php" method="post">
            ...
            <input type="number" name="date_due_month" placeholder="Enter month MM" maxlength=2 pattern="[0-9]{2}" min="01" max="12">
            <input type="number" name="date_due_day" placeholder="Enter day DD" maxlength=2 pattern="[0-9]{2}" min="01" max="31">
            <input type="number" name="date_due_year" placeholder="Enter year YYYY" maxlength=4 pattern="[0-9]{4}"><br><br>
