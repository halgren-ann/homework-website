...
function start() {
    ...
    if(localStorage["MilleBornesBackground"]) {
        document.getElementById("nonSidebar").style.backgroundImage = 'url("' + localStorage["MilleBornesBackground"] + '")';
    }
    else document.getElementById("nonSidebar").style.backgroundImage = 'url("panelBackground.png")';
}
...
function reshuffle() {
    ...
    //deep copy
    var tempArray = JSON.parse(JSON.stringify(discardPileArray));
    //discardPileArray = [];
    /*
    //populate the draw pile
...
function endGame(winner) {
    ...
    if(winner == player_number) {
        ...
        document.getElementById("lossbanner").innerHTML = "You Lost\n" + window[display_name + winner] + " Won";
